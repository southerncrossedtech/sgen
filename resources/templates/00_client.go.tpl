// Code generated by sgen/v{{.Metadata.SGenVersion}} (https://github.com/southerncrossedtech/sgen). DO NOT EDIT.
...
const apiVersion = "{{.Metadata.Version}}"

// uaVersion is the userAgent version sent to your API so they can track usage
// of this library.
const uaVersion = "{{.Metadata.Title}}-{{.Metadata.Version}}"
...
// Client manages communication with the {{.Metadata.Title}} API.
type Client struct {
...
func NewClient(opts *Opts) (*Client, error) {
	...
	client := &Client{
		...
		userAgent: fmt.Sprintf(
			"sgen/{{.Metadata.Title}} %s; Go (%s) [%s-%s]",
			uaVersion,
			runtime.Version(),
			runtime.GOARCH,
			runtime.GOOS,
